...
\section{Wstęp}
Celem instrukcji jest przedstawienie procesu instalacji i konfiguracji maszyny wirtualnej (VirtualBox) oraz instalacji systemu operacyjnego Linux Ubuntu. Środowisko to posłuży do bezpiecznego testowania skryptów i nauki administracji systemem.
